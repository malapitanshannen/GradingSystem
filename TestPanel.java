...
public class TestPanel extends JFrame {
    ...
    private void calculateFinalGrade() {
        ...
        activityLabel.setText(String.format("Activity Grade is: %.2f"));
        double labsAverage = calculateAverage(labScores);
        laboratoryLabel.setText(String.format("Laboratory Grade is: %.2f"));
        double examsAverage = calculateAverage(examScores);
        examLabel.setText(String.format("Exam Grade is: %.2f"));
